...
//app->Options()->Set| eval_gValue("(eval_f",  //|); eval_jac_g | eval_grad_f | eval_h) CasADi::FunctionInternal
    ...
    app->Options()->SetIntegerValue("print_level",  5); //Output verbosity level.(see IPOPT documentation) CasADi::IpoptInternal
    ...
    app->Options()->SetStringValue("sb",  "no"); //(see IPOPT documentation CasADi::IpoptInternal
