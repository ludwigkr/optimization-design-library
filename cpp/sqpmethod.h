...
public:
    ...
    Eigen::VectorXd solve_line_search(quadratic_problem_values *quad_prob_values);
    ...
    Eigen::VectorXd solve_casadi(quadratic_problem_values *quad_prob_values);
#endif
#ifdef OPTI_ROSVIS
...
private:
    ...
    double l1_sum_viol(Eigen::VectorXd z, quadratic_problem_values *quad_prob_valuess);
    void backtracking_casadi(problem_solution *prev_qpsolution, problem_solution *qpsolution, quadratic_problem_values *quad_prob_valuess);

    Eigen::VectorXd gradient_lagrangian(problem_solution *prob_sol, quadratic_problem_values *quad_prob_values);
